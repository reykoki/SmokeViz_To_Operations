...
def main(input_dt, lat=None, lon=None, sat_num='16', product='ABI-L1b-Rad', scope='F', check_sun=True, bands=[1,2,3]):
    ...
    return download_goes(dt, lat, lon, sat_num, product, scope, bands)
...
if __name__ == '__main__':
    ...
    main( input_dt, lat, lon, bands = [1,2,3])
